...
if [ "$1" == "Hybrid-Tool-Appium-Workshop-Example" ]; then
  ...
  rm -rf ./Workshop-Examples/Workshop-Part-Three/RobotFramework-Metrics-Results/*.xml
  rm -rf ./Workshop-Examples/Workshop-Part-Three/RobotFramework-Metrics-Results/*.html
  rm -rf ./Workshop-Examples/Workshop-Part-Three/most-recent-sbtm-android-test-session-metrics.xml &&
  rm -rf ./Workshop-Examples/Workshop-Part-Three/most-recent-sbtm-android-test-session-log.html &&
  rm -rf ./Workshop-Examples/Workshop-Part-Three/most-recent-sbtm-android-test-session-metrics.html &&
  ##--> Create more Robot Framework test files for more phases as needed. Add them to the same folder.
  for ((i = 1; i <= $NUMBER_OF_SESSIONS; i++)); do
      echo
      echo "This is Session-Based Test number $i."
      ...
      read -p "-> Please provide a Jira Task Number for this testing session: " JIRA_TASK_NUMBER
      echo
      robot --nostatusrc --variable TEST_ENVIRONMENT:${TEST_ENVIRONMENT} --variable TESTER_NAME:${TESTER_NAME} --variable SESSION_NUMBER:${i} --variable PULL_REQUEST_NUMBER:${PULL_REQUEST_NUMBER} --variable JIRA_TASK_NUMBER:${JIRA_TASK_NUMBER} --report NONE --log $TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_log.html --output $TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_output.xml -N "$TESTER_NAME tested Jira Task Number $JIRA_TASK_NUMBER in the $TEST_ENVIRONMENT environment -- GitHub Pull Rquest Number $PULL_REQUEST_NUMBER was deployed to that environment -- Session-Based Test number $i for $TIMESTAMP2 on Android -- " -d ./Workshop-Examples/Workshop-Part-Three/ ./Workshop-Examples/Tests/Workshop-Part-Two/*-Android.robot &&
      cp ./Workshop-Examples/Workshop-Part-Three/$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_output.xml ./Workshop-Examples/Workshop-Part-Three/RobotFramework-Metrics-Results/$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_output.xml &&
      cp ./Workshop-Examples/Workshop-Part-Three/$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_log.html ./Workshop-Examples/Workshop-Part-Three/RobotFramework-Metrics-Results/$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_log.html &&
      robotmetrics --email false --inputpath ./Workshop-Examples/Workshop-Part-Three/RobotFramework-Metrics-Results --output "$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_output.xml" --log "$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_log.html" --logo "https://upload.wikimedia.org/wikipedia/commons/e/e4/Robot-framework-logo.png" &&
      cp ./Workshop-Examples/Workshop-Part-Three/$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_output.xml ./Workshop-Examples/Workshop-Part-Three/most-recent-sbtm-android-test-session-metrics.xml &&
      cp ./Workshop-Examples/Workshop-Part-Three/$TESTER_NAME-$TIMESTAMP1-Jira-Task-Number-$JIRA_TASK_NUMBER-GitHub-PR-Number-$PULL_REQUEST_NUMBER-Session-Number-$i-android_sbtm_functional_test_log.html ./Workshop-Examples/Workshop-Part-Three/most-recent-sbtm-android-test-session-log.html &&
      rm -rf ./Workshop-Examples/Workshop-Part-Three/metrics-2*.html &&
      robotmetrics --email false --inputpath ./Workshop-Examples/Workshop-Part-Three --output "most-recent-sbtm-android-test-session-metrics.xml" --log "most-recent-sbtm-android-test-session-log.html" --logo "https://upload.wikimedia.org/wikipedia/commons/e/e4/Robot-framework-logo.png" &&
      cp -fR ./Workshop-Examples/Workshop-Part-Three/metrics-2*.html ./Workshop-Examples/Workshop-Part-Three/most-recent-sbtm-android-test-session-metrics.html &&
      sleep 5s
  done
  rm -rf ./Workshop-Examples/Workshop-Part-Three/metrics-2*.html &&
  rm -rf ./Workshop-Examples/Workshop-Part-Three/RobotFramework-Metrics-Results/*_test_log.html &&
